...
class Data:
    ...
    def extract(cls, day_month_year):
        ...
        for i in day_month_year.replace('-', ' ').split():
            my_date.append(i)
...
today = Data('11-2- 2021')
print(today)
print(Data.valid(43, 2, 2022))
print(today.valid(11, 13, 2011))
print(today.valid(11, 11, -1011))
print(Data.extract('11 - 12 - 2013'))
print(today.extract('18 - 9 - 2020'))
print(Data.valid(1, 11, 2111))
